                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="<?php echo Product::getProductImage($product['id']); ?>">
                                        <img class="d-block w-100" src="<?php echo Product::getProductImage($product['id']); ?>" alt="First slide">
                                    </a>
                                    </div>
                                </div>
